...
<div class="container padBot" style="height: 800px;background-image: url('img/bgall2.jpg')"><br><br>
    <div class="row">
        ...
        <article class="span8 about-box">
            <h5 style="color: white;margin-top: 10px;margin-left: -50px">Agent Client Info</h5>
                                        <table style="margin-left: -210px;width: 1000px">
                                            ...
                                            <%
                                                    String  id,name,bank,organization,occ,email,address,sex,age,policy = null;
                                                    int agno = (Integer)session.getAttribute("UID");
                                                    String sql = "select * from client where agno = '"+agno+"' " ;
