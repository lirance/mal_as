                                        ...
                                        <div class="clearfix">
                                            <div class="nav-collapse nav-collapse_">
                                                <ul class="nav sf-menu clearfix">
                                                    ...
                                                    <li class="active"><a href="dlogin.jsp">Agent Login</a></li>
                                                    <li><a href="tpalogin.jsp">PolicyHolder Login</a></li>
                                                    <li><a href="contact.html">Agent Registration</a></li>
                                                    <li><a href="contact2.html">PolicyHolder Registration</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
