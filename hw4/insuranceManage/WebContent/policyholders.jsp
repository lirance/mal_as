                            ...
                            <div class="clearfix">
                                <div class="nav-collapse nav-collapse_">
                                    <ul class="nav sf-menu clearfix">
                                        ...
                                        <li><a class="active" href="policyholders.jsp">clients</a></li>                                                                    
    ...
    <div class="row">
        <article class="span4" style="color: white">
            ...
            <ol class="list1">
                ...
                <li><a class="active" style="font-size: 20px;" href="policyholders.jsp">clients</a></li>                                                                    
        ...
        <article class="span8 about-box">
            <h5 style="color: white;margin-top: 10px;margin-left: -50px">personal Info</h5>
                                       <table style="margin-left: -210px;width: 1000px">
                                            ...
                                            <%
                                                    String  id,agno,name,bank,organization,occ,email,address,sex,age,policy = null;
                                            ...
                                            <tr style="border: solid 1px;font-size: 15px;color: white;font-family: monospace;font-weight: bold;">
                                                ...
                                                <td style="text-align: center" ><%=agno%></td>
                                                <td style="text-align: center"><%=name%></td>
                                                <td style="text-align: center" ><%=bank%></td>
                                                <td style="text-align: center" ><%=organization%></td>
