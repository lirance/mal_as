                            ...
                            <div class="clearfix">
                                <div class="nav-collapse nav-collapse_">
                                    <ul class="nav sf-menu clearfix">
                                        ...
                                        <li><a class="active"  href="policylist.jsp">policy list</a></li>
    ...
    <div class="row">
        <article class="span4" style="color: white">
            ...
            <ol class="list1">
                ...
                <li><a class="active"  style="font-size: 20px;" href="policylist.jsp">policy list</a></li>
                                                                                  
                <li><a style="font-size: 20px;" href="newpolicy.jsp">new policy</a></li>
                
                <li><a style="font-size: 20px;" href="index.jsp">Logout</a></li>
            </ol>
        </article>
        <article class="span8 about-box">
            <h5 style="color: white;margin-top: 10px;margin-left: -50px">policy Info
            </h5>
                                       ...
                                       <table style="margin-left: -210px;width: 1000px">
                                            <tr style="border: solid 1px;font-size: 20px;color: burlywood;font-family: monospace;font-weight: bold;">
                                               <td style="text-align: center;height: 40px">Pid</td>
                                                <td style="text-align: center;">Policy Name</td> 
                                            ...
                                            <%
                                                    String  id,name,weekly,monthly,quarter,half,year = null;
